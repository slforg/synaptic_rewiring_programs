...
c$omp do
      ...
      ids1=1
      if(jkd+1.eq.ik1) ids1=2
      ids2=1
      if(jkd+1.eq.ik2) ids2=2
      idt1=1
      if(ist.eq.isp1t) idt1=2
      idt2=1
      if(ist.eq.isp2t) idt2=2
c  
...
c
      rid=dpch(idx0,idy0,idrss,it0)-rsh(idx0,idy0)
